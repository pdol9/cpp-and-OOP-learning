...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/07 00:44:26 by pdolinar          #+#    #+#             */
/*   Updated: 2023/01/07 00:44:27 by pdolinar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::~Form()
{
	std::cout << "Form: " << _name << " :Deconstructor called" << std::endl;
}
		...
		, _formSigned(false)
{
	...
	std::cout << "Form: " << _name << " :Constructor initializing private members called" << std::endl;
}
...
const char* Form::InvalidRequest::what( void ) const throw()
{
